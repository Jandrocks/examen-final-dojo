...
public class User {
	...
	// Relacion 1:n a Canciones
	@OneToMany(mappedBy = "relacion", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	private List<Song> cancionesrelacion;

	public List<Song> getCancionesrelacion() {
		return cancionesrelacion;
	}

	public void setCancionesrelacion(List<Song> cancionesrelacion) {
		this.cancionesrelacion = cancionesrelacion;
	}
